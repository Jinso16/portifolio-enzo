...
export default function TPIFS() {
    ...
    return (
        <section className={styles.tpifs}>
            ...
            <img data-tpifstv-image src="/Videogames/TPIFS/tpifsTV.png" alt="" />
            ...
            <div className={styles.leftTextImage}>
                ...
                <img src="/Videogames/TPIFS/tpifsQuartoMarco.png" alt="" />
            </div>
            ...
            <div className={styles.tripleDiv}>
                ...
                <img src="/Videogames/TPIFS/tpifsBanner.png" alt="" />
            ...
            <div className={styles.twoImages}>
                <img src="/Videogames/TPIFS/tpifsCar.png" alt="" />
                <img src="/Videogames/TPIFS/tpifsMinigame.png" alt="" />
            </div>

            <div className={styles.twoTexts}>
                <p>
                    Este projeto é a prova viva da minha crença de que os videogames são a forma de arte mais complexa e completa que se pode conceber, pois exigem o domínio de múltiplas disciplinas, fundindo a espinha dorsal da narrativa (minha escrita criativa), a identidade visual (minha direção de arte), o pulso emocional da trilha sonora e a interação da mecânica em uma única experiência. 
                </p>

                <p>
                    "The Place I Feel Safe" polariza e demonstra, de forma inequívoca, minhas habilidades como artista multimídia, mostrando que posso não apenas escrever uma história envolvente, mas também dar-lhe vida através de uma visão artística e técnica rigorosa.
                </p>
            </div>
