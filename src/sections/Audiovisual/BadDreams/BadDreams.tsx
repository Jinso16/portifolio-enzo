        ...
        <section className={styles.badDreams}>
            ...
            <div className={styles.leftTextImage}>
                ...
                <div className={styles.image1}>
                    <img src="/Audiovisual/BadDreams/bad1.jpg" alt="" />
                </div>
            </div>

            <div className={styles.twoImages}>
                <div className={styles.image1}>
                    <img src="/Audiovisual/BadDreams/bad2.jpg" alt="" />
                </div>
                <div className={styles.image2}>
                    <img src="/Audiovisual/BadDreams/bad3.jpg" alt="" />
                </div>
            </div>

            <div className={styles.leftTextImage}>
                <div className={styles.image1}>
                    <img src="/Audiovisual/BadDreams/bad4.jpg" alt="" />
                </div>
            ...
            <div className={styles.threeImages}>
                <div className={styles.img1}>
                    <img src="/Audiovisual/BadDreams/bad5.jpg" alt="" />
                </div>
                <div className={styles.img2}>
                    <img src="/Audiovisual/BadDreams/bad7.jpg" alt="" />
                </div>
                <div className={styles.img3}>
                    <img src="/Audiovisual/BadDreams/bad6.jpg" alt="" />
                </div>
            </div>
            ...
            <img className={styles.soloImage} src="/Audiovisual/BDITNimg.png" alt="" />
        </section>
    )
}